...
4. Accessing via WebUI or browser, add your SSH server profile in the Profiles tab and tap **Start Tunnel**.
...
- Need help? open a [GitHub Issue](https://github.com/GoodyOG/SSHCustom-Magisk/issues), with core log
